...
<script>
      <?php
            ...
            // Update district locations to Kerala
            $q3="SELECT count(*) as count FROM food_donations where location=\"Thiruvananthapuram\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $thiruvananthapuram=$ro3['count'];

            $q4="SELECT count(*) as count FROM food_donations where location=\"Kochi\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $kochi=$ro4['count'];

            $q5="SELECT count(*) as count FROM food_donations where location=\"Kozhikode\"";
            $res5=mysqli_query($connection, $q5);
            $ro5=mysqli_fetch_assoc($res5);
            $kozhikode=$ro5['count'];
    ?>
var xValues = ["Male","Female"];
var xplace=["Thiruvananthapuram","Kochi","Kozhikode"];
var yplace=[<?php echo json_encode($thiruvananthapuram,JSON_HEX_TAG);?>,<?php echo json_encode($kochi,JSON_HEX_TAG);?>,<?php echo json_encode($kozhikode,JSON_HEX_TAG);?>];
